            ...
            <div className="container">
                <div className="footer__info">
                    <div className="footer__info-column column-1">
                        <Logo/>
                        <div className="about-brand">Cillum eu id enim aliquip aute ullamco anim. Culpa deserunt nostrud
                            excepteur voluptate.
                        </div>
                        <FindUs/>
                    </div>
                    ...
                    <div className="footer__info-column column-4">
                        ...
                        <div className="newsletter-text">Subscribe to be the first to hear about deals, offers and
                            upcoming
                            collections.
                        </div>
