...
import { Categories } from '@/components/shopPage/filters/categories/Categories.jsx';
import { Price } from '@/components/shopPage/filters/price/Price.jsx';
import { Colors } from '@/components/shopPage/filters/colors/Colors.jsx';
...
export function Sidebar({
    ...
    return (
        <div className="sidebar">
            ...
            <div>
                <a href="#">
                    <img src="../../../assets/images/season-sale-banner.svg" alt="Season Sale Banner" />
                </a>
            </div>
        </div>
    );
